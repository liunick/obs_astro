...
plot(new_b_data$delta_mag, new_b_data$peak_mag, main="mag_15_delta vs mag_peak (Band = B)", xlab="mag_15_delta", ylab="mag_peak")
...
plot(new_v_data$delta_mag, new_v_data$peak_mag, main="mag_15_delta vs mag_peak (Band = B)", xlab="mag_15_delta", ylab="mag_peak")
...
plot(new_i_data$delta_mag, new_i_data$peak_mag, main="mag_15_delta vs mag_peak (Band = B)", xlab="mag_15_delta", ylab="mag_peak")
